...
export function Topbar() {
  ...
  // Open video call modal when call starts
  useEffect(() => {
  ...
  const handleVideoCallClick = () => {
    if (videoCall.isInCall) {
      ...
      // For demo purposes, you would typically show a user selection dialog
      // For now, we just open the modal to show the waiting state
      setVideoCallModalOpen(true);
    }
  };
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          title={videoCall.isInCall ? 'Open video call' : 'Start video call'}
        >
