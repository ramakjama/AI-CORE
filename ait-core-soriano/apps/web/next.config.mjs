...
const performanceConfig = await import('../../performance.config.js').then(m => m.default);
...
const nextConfig = {
  ...
  webpack: (config, { dev, isServer, webpack }) => {
    ...
    // Compression
    if (!dev && !isServer) {
      const CompressionPlugin = await import('compression-webpack-plugin').then(m => m.default);
